...
def mainmawaris(datamawaris):
    ...
    return render_template('/materi/mawaris/index_mawaris.html', data=hasil_baru)
...
@mawaris.route('/edit_video/<int:id>/<int:idTema>',  methods=["GET", "POST"])
def edit_video(id, idTema):
    ...
    if cari_materi is None:
        return f"Gagal mencari materi dengan id: {id}.", 400
    return render_template('materi/mawaris/tema/edit_video.html/', form=form, data=cari_materi)


@mawaris.route('/updatevideo/<int:id>/<int:idTema>', methods=["POST"])
